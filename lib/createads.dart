...
class createads extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                              ...
                              children: <Widget>[
                                Stack(
                                  children: [
                                    ...
                                    Padding(
                                      padding:
                                          EdgeInsets.only(left: 120, top: 90),
                                      child: Row(
                                        crossAxisAlignment:
    ...
    EdgeInsets.only(left: 30, top: 10),
                                    ...
                                    Column(
                                      children: [
                                        Padding(padding:EdgeInsets.only(left:20,top:3),
                                          child: Row(children: [
                                            ElevatedButton(
                                              child: const Text(
                                                'HYBRID',
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child:  Text('Describe what you are selling',
                                                style: TextStyle(
